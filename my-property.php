...
<!-- Mirrored from shreethemes.net/resido-live/resido/my-property.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jun 2024 15:37:55 GMT -->
<head>
		<meta charset="utf-8">
									...
									<li>
										<div class="btn-group account-drop">
											<button type="button" class="btn btn-order-by-filt dropdown-toggle" id="showbuttons" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
												<img src="assets/img/team-1.jpg" class="avater-img" alt="">
											</button>
											<div class="dropdown-menu pull-right animated flipInX" id="showings">
												...
												<a href="my-profile.html"><i class="fa-solid fa-address-card"></i>My Profile</a>                                  
												<a href="my-property.html"><i class="fa-solid fa-building-circle-check"></i>My Property</a>                                   
												<a href="bookmark-list.html"><i class="fa-solid fa-bookmark"></i>Bookmarked Property</a>                                   
												<a href="submit-property-dashboard.html"><i class="fa-solid fa-house"></i>Submit Property</a>                                   
												<a href="change-password.html"><i class="fa-solid fa-unlock"></i>Change Password</a>
											</div>
										</div>
									</li>
								</ul>
								...
								<li>
									<div class="btn-group account-drop">
										<button type="button" class="btn btn-order-by-filt dropdown-toggle" id="showbutton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
											<img src="assets/img/team-1.jpg" class="avater-img" alt="">Hi, Admin
										</button>
								...
								<div class="sidebar-widgets">
									<div class="dashboard-navbar">
										...
										<div class="d-user-avater">
											<img src="assets/img/team-1.jpg" class="img-fluid avater" alt="">
										...
										<div class="d-navigation">
											<ul>
												...
												<li><a href="my-profile.html"><i class="fa-solid fa-address-card"></i>My Profile</a></li>
												<li><a href="bookmark-list.html"><i class="fa-solid fa-bookmark"></i>Bookmarked Listings</a></li>
												<li class="active"><a href="my-property.html"><i class="fa-solid fa-building-circle-check"></i>My Properties</a></li>
												<li><a href="submit-property-dashboard.html"><i class="fa-solid fa-house"></i>Submit New Property</a></li>
									...
									<div class="col-md-12 col-sm-12 col-md-12">
										<div class="singles-dashboard-list">
											...
											<div class="sd-list-right">
												<h4 class="listing_dashboard_title"><a href="#" class="text-primary">My List property Name</a></h4>
