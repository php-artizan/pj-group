    ...
    <div class="row gx-5">
        <aside class="col-lg-6">
            ...
            <?php
                ...
                $get="SELECT * from ads LEFT JOIN ads_images 
                    ON ads.id=ads_images.ad_id WHERE ads.id='$id'";
            ...
            <div class="d-flex justify-content-center mb-3">
                    <?php 
                        if (!empty($row['path'])) {
                            echo '<img class="rounded-2" src=".././' . $row['path'] . '" width="360" height="360">';
                        }else{
                            echo '<img class="rounded-2" src=".././assets/propertyImages/default.png" width="250" height="250">';
                        }
                    ?>
      ...
      <main class="col-lg-6 bg-secondary pt-4 pb-4 rounded-3">
        <div class="ps-lg-3">
          ...
          <div class="mb-3">
            <strong class="text-success">Public Status: </strong>
          ...
          <div class="mb-3">
            ...
            <span class="h5">
                    <span class="label text-light badge <?php echo $statusClass ?>"><?php echo ucwords($statusText) ?></span>
            </span>
          </div>
         ...
         <h2 class="text-success">Feature Details</h2>
          <?php
                if (isset($_GET['id'])) {
                    $id = $_GET['id'];
        ...
        ?>
         ...
         <h2 class="text-success">Ameneties</h2>
        <div class="row mb-4">
