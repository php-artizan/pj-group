...
//                    }  ?>
                                                    ...
                                                    <div class="modal-body px-5 my-7">
                                                        ...
                                                        <form class="form" action="controller/addController.php"
                                                            ...
                                                            <div class="text-center pt-10">
                                                                ...
                                                                <button type="submit" name="submitAddCategoryBtn"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body px-5 my-7">
                                                ...
                                                <form class="form" action="controller/addController.php" method="POST"
                                                    id="AdCategoryUpdate" enctype="multipart/form-data">
                                                    ...
                                                    <div class="text-center pt-10">
                                                        ...
                                                        <button type="submit" name="AdCategoryUpdate"
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="#" data-bs-toggle="modal"
                                                                ...
                                                                class="menu-link adsCategoryEdit px-3">
                                                                Edit
                                                            </a>
                                                        </div>
                                                        <!--end::Menu item-->
    ...
    $(document).ready(function() {
        ...
        $(".adsCategoryEdit").on("click", function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#image_field_update").children('img').attr('src',imageUrl)
