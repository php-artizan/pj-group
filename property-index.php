                            ...
                            <div class="full-search-2 eclip-search italian-search hero-search-radius shadow-hard mt-5  " style="width: 1000px; ">
                                <div class="hero-search-content">
                                    <div class="row ">
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-md-4 col-sm-12 p-md-0 elio ">
                                        ...
                                        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-12">
                                            <div class="form-group mb-2">
                                                <div>
                                                    Area Size
                                                    <select id="town" class="form-control" placeholder="Select Area Size">
                                                        <option value="" selected disabled hidden>Select Area Size</option>
                                                        <option value="1">1 Marla</option>
                                                        <option value="2">3 Marla</option>
                                                        <option value="3">5 Marla</option>
                                                        <option value="4">7 Marla</option>
                                                        <option value="5">10 Marla</option>
                                                        <option value="6">15 Marla</option>
                                                        <option value="7">1 kanal</option>
                                                        <option value="8">2 kanal</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
