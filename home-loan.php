                        ...
                        <div class="col-lg-9 col-md-11 col-sm-12 ">
                            ...
                            <div class="full-search-2 eclip-search italian-search hero-search-radius shadow-hard mt-5  " style="width: 1000px; ">
                                <div class="hero-search-content">
                                    <div class="row">
                                        <div class="col">
                                            <div class="mb-3">Property Price</div>
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <div>PKR <span id="pkramount">0</span></div>
                                                <div><span id="rupeestrans">Zero</span></div>
                                            </div>
                                            <hr>
                                            <input type="range" class="form-range" id="customRange1" min="0" max="100000000000" step="1000000" oninput="showValue(this.value)">
                                        </div>
                                        <div class="col">
                                        <div class="mb-3">Property Price</div>
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                             <button type="button" class="btn btn-dark full-width">Calculate </button>
