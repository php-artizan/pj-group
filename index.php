									...
									<div class="position-relative">
										...
										<div class="list-img-slide">
											<div class="click mb-0 rounded-3 overflow-hidden">
												...
												<div><a href="single-property-1.php"><img src="<?=$image['path']?>" class="img-fluid" alt="" /></a></div>
												<?php } ?>
								...
								<div class="listing-caption-wrapper px-3">
									<div class="listing-detail-wrapper">
										<div class="listing-short-detail-wrap">
											<div class="listing-short-detail">
												...
												<h4 class="listing-name fw-semibold fs-6 mb-0"><a href="single-property-1.php" class="prt-link-detail"><?=$property['title'];  ?></a></h4>
									...
									<div class="price-features-wrapper d-flex align-items-center justify-content-between my-4">
										<div class="listing-short-detail-flex">
											<h6 class="listing-card-info-price text-primary ps-0 m-0"><?=$property['price'];  ?></h6>
										</div>
