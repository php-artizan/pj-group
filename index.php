...
$locations = CustomOperations::get_rows("SELECT * FROM location");
$categories = CustomOperations::get_rows("SELECT * FROM categories");

$all_amenties = Amenties::all();

$ad_prices = CustomOperations::get_row("SELECT MAX(price) as max, MIN(price) as min  FROM ads ");
		// dd($ad_prices);
								...
								<div class="hero-search-content">
									<div class="row">
													...
													<ul>
														<li>
															<div class="form-check">
																<input class="form-check-input" type="radio" id="typbuy" value="sale" name="main_type">
														...
														<li>
															<div class="form-check">
																<input class="form-check-input" type="radio" id="typrent" value="rent" name="main_type" checked>
										...
										<div class="col-xl-6 col-lg-6 col-md-4 col-sm-12 p-md-0 elio">
											<div class="form-group border-start borders">
												<div class="position-relative">
													<input type="text" class="form-control border-0 ps-5" placeholder="Search ads..." name="query">
										...
										<div class="col-xl-2 col-lg-2 col-md-3 col-sm-12">
											<div class="form-group">
												<button type="submit" class="btn btn-dark full-width" name="search">Search</button>
											</div>
										</div>
									...
									<div class="collapse" id="advance-search" aria-expanded="false" role="banner">
											...
											<div class="col-lg-4 col-md-4 col-sm-12">
												<div class="form-group mb-2">
													<div class="input-with-icon">
														<select id="town" name="location_id" class="form-control">
										...
										<!-- row -->
										<div class="row">
											<?php foreach ($all_amenties as $amenty) {
												$group_name = $amenty['title'];
												?>
												<div class="col-lg-12 col-md-12 col-sm-12 mt-3">
													<h5 class="text-dark"><?=$group_name;?></h5>
													<ul class="m-0 p-0 third-row">
															...
															if( count($amenty['items']) != 0 ) {
																foreach ($amenty['items'] as $item){
																	...
																	<li>
																		...
																		<label for="<?=$item['slug']?>" class="form-check-label">
																			<input id="<?=$item['slug']?>" class="form-check-input" name="<?=$item['slug']?>" value="<?=$item['id']?>" type="checkbox">
